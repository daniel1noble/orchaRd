...
pacman::p_load(devtools, tidyverse, metafor, patchwork, R.rsp, orchaRd, emmeans, ape, phytools, flextable, rotl, clubSandwich)
```
...
The `pub_bias_plot()` function takes the output of `orchard_plot()` and adds the bias-corrected mean estimates. 
