...
author: "S. Nakagawa, M. Lagisz, R. E. O’Dea, J. Rutkowska, Y. Yang, A. M. Senior & D.W.A. Noble"
date: "`r Sys.Date()`"
...
First, we'll return to the @Lim2014 dataset. Here, we can fit a model that assessing time-lag effects for studies on captive and wild populations. Say, for the sake of argument, that we expect the time-lag effect to vary by lab/wild conditions. We can fit an interaction model and create bubble plots for these situations (Figure \@ref(fig:bubbleslim)):

```{r, bubbleslim, fig.cap= "Bubble plot with Lim et al. 2014 dataset assessing publication bias (time-lag bias) in wild and captive studies.", echo = TRUE, eval = TRUE, warning=FALSE, message=FALSE, class.source='klippy'}
...
#### Example 6: Meta-regression and marginalised mean effect sizes
