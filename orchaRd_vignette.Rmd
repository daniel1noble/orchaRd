...
mod.body_mass <-  rma.mv(yi = dARR, V = Var_dARR,mods= ~body_mass*habitat, method="REML", test="t", dfs="contain",
                           random=list(~1|species_ID, ~1|es_ID), data = pottier2)

test <- orchaRd::mod_results(mod.body_mass, mod = "body_mass", group = "species_ID", by = "habitat",data = pottier2)
orchaRd::bubble_plot(test, mod = "body_mass", by = "habitat", legend.pos = "top.left", data = pottier2)

orchaRd::bubble_plot(mod.body_mass, mod = "body_mass", by = "habitat", group = "species_ID", legend.pos = "top.left", data = pottier2)
