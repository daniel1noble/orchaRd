...
het_model <- orchaRd::marginal_means(model_het, group = "group_ID", mod = "trait.type", 
                           weights = "prop", data = warm_dat)
